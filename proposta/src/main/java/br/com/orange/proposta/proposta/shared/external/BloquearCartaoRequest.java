...
import br.com.orange.proposta.proposta.shared.external.dto.BloqueioCartaoResponse;
...
public interface BloquearCartaoRequest {
	...
	public BloqueioCartaoResponse bloquearCartao(@PathVariable("id") String numeroCartao,
			@RequestBody SistemaResponsavelRequest sistema);
}
